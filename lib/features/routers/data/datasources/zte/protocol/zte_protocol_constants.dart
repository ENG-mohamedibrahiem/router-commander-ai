...
/// Do NOT add a constant here without stating its classification.
///
/// Conventions:
...
/// The single HTTP endpoint used for ALL read operations on ZTE routers.
...
/// The HTTP endpoint used for ALL write/action operations on ZTE routers.
/// classification: VERIFIED — confirmed across MF79U, MF266, MF297D, MC801A.
...
/// known firmware typo). Both spellings accepted by ZteAuthenticationStrategy.
...
/// Note: ONLY required for write operations. Read operations do not need AD.
